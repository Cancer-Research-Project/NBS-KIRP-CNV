...
PYTHONBUFFERED = 1
# here name prdfix is the prefix for the file name
...
def do_nbs(maf_path, sm_path, network_filepath, clinical_path, surv_data, output_filepath, name_prefix, clusters, niter, alpha):
    ...
    outdir = output_filepath+'c'+str(clusters)+'_i'+str(niter)+'/'
    ...
    job_name = name_prefix+str(clusters)+'_i'+str(niter)
    ...
    for i in range(niter):
        ...
        Hlist.append(pyNBS_single.NBS_single(sm_mat, k=clusters))
